...
- [Example 1](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API) - Fetch API in JavaScript documentation.
- [Example 2](https://icanhazdadjoke.com/api) - Dad joke APIs.
